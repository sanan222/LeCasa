...
from tasks.single_stage_so101.environments.kitchen_orangetoplate import (
    OrangeToPlatePnP as _EnvOrangeToPlatePnP,
)
from tasks.teleoperator import SO101TeleoperationController
import xml.etree.ElementTree as ET


class OrangeToPlateTeleop(SO101TeleoperationController):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.kitchen_env = None

    def initialize_kitchen_environment(self):
        self.kitchen_env = _EnvOrangeToPlatePnP(
